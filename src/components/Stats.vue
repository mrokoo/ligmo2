<template>
  <div class="stats shadow w-full grid-cols-3">
    <div class="stat">
      ...
      <div class="stat-title">In Porgress</div>
    ...
    <div class="stat">
      <div class="stat-figure">
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" class="inline-block w-8 h-8 stroke-current" fill="currentColor">
